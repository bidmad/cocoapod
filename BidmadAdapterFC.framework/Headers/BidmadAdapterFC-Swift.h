...
@interface BidmadAdColonyBanner (SWIFT_EXTENSION(BidmadAdapterFC)) <BidmadADCAdViewDelegate>
...
@protocol BidmadADCInterstitial;

@interface BidmadAdColonyInterstitial (SWIFT_EXTENSION(BidmadAdapterFC)) <BidmadADCInterstitialDelegate>
