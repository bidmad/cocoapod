...
#ifndef BIDMADFLUTTERBRIDGE_SWIFT_H
#define BIDMADFLUTTERBRIDGE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BidmadFlutterBridge",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@protocol NSObject;
SWIFT_CLASS("_TtC19BidmadFlutterBridge38OpenBiddingFlutterBannerRefinedFactory")
...
@class UIView;
SWIFT_CLASS("_TtC19BidmadFlutterBridge43OpenBiddingFlutterBannerRefinedPlatformView")
...
@interface OpenBiddingFlutterInterstitial (SWIFT_EXTENSION(BidmadFlutterBridge)) <BIDMADOpenBiddingInterstitialDelegate>
...
@interface OpenBiddingFlutterRewardVideo (SWIFT_EXTENSION(BidmadFlutterBridge)) <BIDMADOpenBiddingRewardVideoDelegate>
