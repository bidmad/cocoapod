...
@interface BidmadBannerTeadsAdapterSupportChecker : NSObject <BidmadBannerSC>
...
@interface BidmadInterstitialTeadsAdapterSupportChecker : NSObject <BidmadInterstitialSC>
+ (BOOL)isSupported SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
