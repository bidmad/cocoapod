...
@class TeadsAd;
@class BidmadAdUnit;
SWIFT_CLASS("_TtC18BidmadTeadsAdapter24BidmadBannerTeadsAdapter") SWIFT_AVAILABILITY(ios,introduced=13.0.0)
@interface BidmadBannerTeadsAdapter : BidmadBannerAdapter <TeadsAdDelegate, TeadsInReadAdPlacementDelegate>
...
SWIFT_CLASS("_TtC18BidmadTeadsAdapter38BidmadBannerTeadsAdapterSupportChecker")
@interface BidmadBannerTeadsAdapterSupportChecker : BidmadSupportChecker
...
SWIFT_CLASS("_TtC18BidmadTeadsAdapter44BidmadInterstitialTeadsAdapterSupportChecker")
@interface BidmadInterstitialTeadsAdapterSupportChecker : BidmadSupportChecker
+ (BOOL)isSupported SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC18BidmadTeadsAdapter38BidmadNativeTeadsAdapterSupportChecker")
@interface BidmadNativeTeadsAdapterSupportChecker : BidmadSupportChecker
+ (BOOL)isSupported SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
