Pod::Spec.new do |s|
  ...
  s.source        = { :git => 'https://github.com/bidmad/cocoapod.git', :tag => 'PARTNER.1.0.1' }
  s.swift_version = '5.0'
  s.static_framework = true
  s.requires_arc = true
  s.vendored_frameworks = "EmptyProject.xcframework"
  s.default_subspec = 'Bidmad_Standard'

  s.subspec 'Bidmad_Standard' do |bidmad_standard|
    bidmad_standard.dependency 'BidmadVungleAdapter', '7.1.0.1'
    bidmad_standard.dependency 'BidmadPangleAdapter', '5.3.1.0.1'
    bidmad_standard.dependency 'BidmadFyberAdapter', '8.2.4.1'
    bidmad_standard.dependency 'BidmadUnityAdsAdapter', '4.8.0.1'
    bidmad_standard.dependency 'BidmadIronSourceAdapter', '7.5.0.0.1'
    bidmad_standard.dependency 'BidmadAppLovinAdapter', '11.11.3.1'
    bidmad_standard.dependency 'BidmadTeadsAdapter', '5.0.27.1'
    bidmad_standard.dependency 'BidmadPubmaticAdapter', '3.2.0.1'
    bidmad_standard.dependency 'BidmadAtomAdapter', '1.0.0.1'
    bidmad_standard.dependency 'BidmadAdFitAdapter', '3.12.7.1'
    bidmad_standard.dependency 'BidmadAdColonyAdapter', '4.9.0.1'
    bidmad_standard.dependency 'BidmadADOPCoupangAdapter', '1.0.0.1'
    bidmad_standard.dependency 'BidmadGoogleAdMobAdapter', '10.12.0.1'
    bidmad_standard.dependency 'BidmadGoogleAdManagerAdapter', '10.12.0.1'
  end
