Pod::Spec.new do |s|
  ...
  s.name             = "BidmadGoogleAdManagerAdapter-ForLuckieverse"
  ...
  s.source           = { :git => 'https://github.com/bidmad/cocoapod.git', :tag => 'BidmadGoogleAdManagerAdapter-ForLuckieverse.12.5.0.12.0' }
