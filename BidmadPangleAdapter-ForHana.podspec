Pod::Spec.new do |s|
  ...
  s.name             = "BidmadPangleAdapter-ForHana"
  s.version          = "7.1.1.1.12.0"
  s.platform         = :ios, "12.0"
  ...
  s.source           = { :git => 'https://github.com/bidmad/cocoapod.git', :tag => 'BidmadPangleAdapter-ForHana.7.1.1.1.12.0' }
