...
#ifndef BIDMADADAPTERDYNAMIC_SWIFT_H
#define BIDMADADAPTERDYNAMIC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BidmadAdapterDynamic",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20BidmadAdapterDynamic23BidmadTeadsInterstitial")
@interface BidmadTeadsInterstitial : BidmadAdapterAdEssential <BidmadAdapterFullscreenAdditional, TeadsAdDelegate, TeadsInReadAdPlacementDelegate>
- (void)load;
- (void)remove;
...
- (nonnull instancetype)initWithAppID:(NSString * _Nonnull)appID pubID:(NSString * _Nullable)pubID rootVC:(UIViewController * _Nullable)rootVC parentView:(UIView * _Nullable)parentView isChild:(NSNumber * _Nullable)isChild isGDPRConsent:(NSNumber * _Nullable)isGDPRConsent isCCPAConsent:(NSNumber * _Nullable)isCCPAConsent bidmadController:(id _Nonnull)bidmadController OBJC_DESIGNATED_INITIALIZER;
