Pod::Spec.new do |s|
  ...
  s.name             = "BidmadUnityAdsAdapter-ForHana"
  s.version          = "4.9.2.12.0"
  s.platform         = :ios, "12.0"
  ...
  s.source           = { :git => 'https://github.com/bidmad/cocoapod.git', :tag => 'BidmadUnityAdsAdapter-ForHana.4.9.2.12.0' }
