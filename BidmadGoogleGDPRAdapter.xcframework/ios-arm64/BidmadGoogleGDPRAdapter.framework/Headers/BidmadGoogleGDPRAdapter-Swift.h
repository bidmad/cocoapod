...
#ifndef BIDMADGOOGLEGDPRADAPTER_SWIFT_H
#define BIDMADGOOGLEGDPRADAPTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BidmadGoogleGDPRAdapter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC23BidmadGoogleGDPRAdapter23BidmadGoogleGDPRAdapter")
@interface BidmadGoogleGDPRAdapter : NSObject <BidmadGDPRAdapter>
