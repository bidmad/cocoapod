...
SWIFT_CLASS("_TtC21BidmadUnityAdsAdapter33BidmadInterstitialUnityAdsAdapter")
@interface BidmadInterstitialUnityAdsAdapter : BidmadFullscreenAdapter <BidmadFullscreenAdapterDelegate>
...
@class NSString;
SWIFT_CLASS("_TtC21BidmadUnityAdsAdapter27BidmadRewardUnityAdsAdapter")
@interface BidmadRewardUnityAdsAdapter : BidmadFullscreenAdapter <UnityAdsLoadDelegate, UnityAdsShowDelegate>
- (void)loadAdWith:(void (^ _Nonnull)(BidmadFullscreenAdapter * _Nullable, NSError * _Nullable))completionHandler;
- (void)showAdFrom:(UIViewController * _Nonnull)viewController;
